...
"byte" 		{ return makeSymbol(sym.BYTE); }
"char" 		{ return makeSymbol(sym.CHAR); }
"short" 		{ return makeSymbol(sym.SHORT); }
"long" 		{ return makeSymbol(sym.LONG); }
...
"++"		{ return makeSymbol(sym.UNARY_INC); }  // Added for post increment
"--"		{ return makeSymbol(sym.UNARY_DEC); }  // Added for post decrement
